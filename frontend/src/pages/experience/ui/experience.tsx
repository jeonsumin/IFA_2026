...
export const Experience = () => (
    <div className="relative min-h-full bg-bg-default">
            {/* 배경 핑크→베이지 그라데이션 */}
            <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-lg-active-red/20 to-lg-gray-6/20"/>

            <div className="relative flex flex-col items-center pb-10 ">
                {/* 상단 히어로(하단 곡선) */}
                <div className="relative h-[210px] w-full ">
                    <img src="/images/experience/hero-photo.png" alt="" aria-hidden
                         className="w-full"/>
                </div>

                {/* 코디네이터 원형 사진 (히어로에 겹침) */}
                <div className="mt-4 size-40 overflow-hidden rounded-full">
                    <img src="/images/experience/coordinator.png" alt="" aria-hidden
                ...
                <div className="w-full px-5 mt-4 grid grid-cols-2 gap-2">
                    {ZONES.map((z) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-x-0 top-0 flex flex-col gap-1 bg-gradient-to-b from-white/60 to-transparent p-3">

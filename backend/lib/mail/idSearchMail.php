...
// Subject
$subject = '[SQUARE] 고객님께서 요청하신 ID 조회 메일입니다.';
		...
		<td>
			...
			<tr>
				<td bgcolor="#ffffff">
					...
					<tr>
						<td><p style="font-family: Arial, sans-serif, Open Sans;font-weight:bold;font-size:22px;letter-spacing:-0.8px;color:#424244;">가입하신 이메일 주소입니다.</p></td>
					</tr>
					<tr>
						<td style="font-family: Arial, sans-serif, Open Sans;color:#424244;font-size:14px;">
						안녕하세요. 스퀘어 입니다.<br>
						회원님께서 가입하신 이메일 주소는 아래와 같습니다.
			...
			<tr>
				<td align="center" style="text-aling:center;vertical-align: middle;padding:20px 0px;">
					<div style="border:1px solid #e5e5e5;padding:20px 30px;">
						...
						Email : <span style="text-decoration:none !important;color:#ee323e !important;"></span>
						</p>
				...
				<td>
					...
					<tr>
						<td style="color:#424244;font-family: Arial, sans-serif, Open Sans;font-size:14px;">
							<a href="https://www.59uare.com" style="text-decoration:none !important; text-decoration:none;">스퀘어 홈페이지</a> 또는 <a href="https://www.59uare.com" style="text-decoration: none;">인스타그램</a>에서 보다 다양한 정보를 확인하실 수 있습니다.
						</td>
					</tr>
					</table>
				</td>
...
$from="서비스관리자";
//$subject="메일 제목입니다.";
$toMail = "minheejung@brightbell.co.kr";
